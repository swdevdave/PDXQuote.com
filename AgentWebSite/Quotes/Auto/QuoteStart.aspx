...
<body>
    ...
    <form id="FormStartPage" runat="server">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="content">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm" required="required" id="InsruanceList1">
                                <option value="">Please Select..</option>
                    ...
                    <div id="BtnPosition">
                        <button type="button" class="btn btn-large bg-primary"  onclick="StartButton_Click" id="StartButton">Add Other Drivers</button>
        ...
        <div><span style="padding-bottom: 50px;">&nbsp<br />
        </span></div>
